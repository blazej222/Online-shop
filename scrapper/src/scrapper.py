...
with open(directory + 'products.csv', 'w', encoding='UTF-8') as f:
    ...
    headers = ['Product ID', 'Active', 'Name', 'Categories', 'Price tax excluded', 'Tax rules ID', 'Cost price',
               'On sale',
               'Discount amount', 'Discount percent', 'Discount from', 'Discount to', 'References',
               'Supplier references',
               'Suppliers', 'Brand', 'EAN13', 'UPC', 'EPN', 'Ecotax', 'Width', 'Height', 'Depth', 'Weight',
               'Delivery time of in-stock',
               ...
               'Label when backorder allowed', 'Avaialble for order', 'Product availability date',
               'Product creation date',
               'Show price', 'Image URLs', 'Image alt texts', 'Delete existing images', 'features',
